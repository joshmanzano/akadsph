      ...
      .then(() => {
        post_api(
          ...
          (res) => {
            console.log(res);
            Toast.success(
              "Gifted " + String(value) + " credits to " + p.email + "!"
            );
          }
        );
      })
          ...
          <DialogContent>
            <Grid container>
              ...
              <Button
                onClick={() =>
                  openInNewTab(
                    process.env.REACT_APP_API_URL + "/parents/" + p.id + "/"
                  )
                }
                color="primary"
                variant="contained"
            ...
            <Grid container>
              ...
              <Typography gutterBottom>Add Favorite Tutor</Typography>
              <Grid container spacing={2} alignItems="center">
                <Grid item xs>
                  <Autocomplete
