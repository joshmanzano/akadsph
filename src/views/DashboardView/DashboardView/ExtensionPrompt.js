  ...
  function buttonClick(type) {
    if (type == "extendMins") {
      ...
      confirm({
        ...
        description:
          "Do you want to extend the session for an additional 30 minutes?",
      })
        .then(() => {
          setOpen(false);
          setOpenJoin(true);
      ...
      confirm({
        title: "Extend Confirmation",
        description:
          "Do you want to extend the session for an additional 1 hour?",
      })
        .then(() => {
          const payload = {
          ...
          post_api("extend-session", payload, (res) => {
            console.log(res);
            toast(
              "Sent request to tutor! Kindly inform your tutor of the extension request."
            );
          });
          setOpen(false);
        })
      ...
      confirm({
        title: "Extend Confirmation",
        description: "Are you sure you do not want to extend the session?",
      })
        .then(() => {
          setOpen(false);
        })
        ...
        <DialogContent className={classes.dialogStyle}>
          <Box align="center" mb={6}>
            <Typography variant="h4" align="center" mb={2}>
              Enjoy your session! You may extend your session by clicking the
          ...
          <Box my={5}>
            <Typography variant="body1" align="center">
              Extending the session by 1 hour means you agree on paying 1 credit
              to book another request at the end of this session.
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions>
