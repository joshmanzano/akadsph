    ...
    <React.Fragment>
      <Box mt={3} mb={6} mx={3}>
        <Grid container spacing={3}>
          ...
          <Grid item lg={12} md={12} xl={12} xs={12} align="center">
            <Container maxWidth="md">
              <Typography variant="h2" align="center">
                Before we can book a tutor, we'd like to know more about your
                child so we can match the best tutor!
              </Typography>
            </Container>
          </Grid>
          <Grid item lg={12} md={12} xl={12} xs={12} align="center">
          ...
          <Grid item lg={12} md={12} xl={12} xs={12} align="center">
            <Container maxWidth="md">
              <Button onClick={submitChild} variant="contained" color="primary">
                Add Child
              </Button>
            </Container>
          </Grid>
