...
const CustomerListView = (props) => {
  ...
  const [url, setURL] = React.useState(
    data["files"] + "?path=%2F" + data["subjects"]["subject_field"]
  );
  ...
  const handleClickOpen = () => {
    if (props.favtutors.length > 0 && data.allTutors) {
      confirm({
        ...
        description:
          "Are you sure you would like to get any tutor for this request?",
  ...
  return (
    <Page className={classes.root} title="Request A Tutor">
      ...
      <Container maxWidth={false}>
        ...
        <React.Fragment>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item lg={12} md={12} xl={12} xs={12} id="tutoringDetails">
              <ChildDetails
                data={data}
                url={url}
                setURL={setURL}
            ...
            <Grid item lg={12} md={12} xl={12} xs={12} id="availability">
              <Availability data={data} setData={setData} />
            </Grid>
            <Grid item lg={12} md={12} xl={12} xs={12} id="specialRequests">
