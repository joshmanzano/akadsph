      ...
      <DialogContent className={classes.dialogStyle}>
        ...
        <Box py={6}>
          ...
          >
            ...
            >
              <Button
                className={!accept ? classes.choicesBtn : classes.selectedBtn}
                onClick={() => buttonClick("accept")}
                variant="outlined"
              >
                Accept
              </Button>
            ...
            <Grid item lg={6} md={6} xl={6} xs={12}>
              ...
              <Button
                className={!decline ? classes.exitBtn : classes.selectExitBtn}
                onClick={() => buttonClick("decline")}
                variant="outlined"
              >
                Decline
              </Button>
