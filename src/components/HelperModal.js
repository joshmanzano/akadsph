      ...
      <DialogContent mx={4}>
        ...
        <Box mt={2}>
          <Grid align="center" spacing={4}>
            ...
            <Grid item>
              <Box my={2}>
                <Button color="primary" variant="contained" onClick={support}>
                  I have a question.
                </Button>
              </Box>
            </Grid>
            <Grid item>
              <Box my={2}>
                <Button
                  ...
                  onClick={() => {
                    user == "parent"
                      ? window.open("https://forms.gle/rJX41yq3kC21azHm7")
                      : window.open("http://tiny.cc/AkadsEATutorFeedback");
                  }}
                >
                  I would like to give feedback about the website.
                </Button>
              </Box>
            </Grid>
          </Grid>
