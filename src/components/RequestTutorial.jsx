...
function Tutorial(props) {
    ...
    const steps = [
      ...
      {
        intro: '<br/><center><img width="70" src="../static/images/oli-wink.png"/></center><br/> <center>You will notified as soon possible when a match has been made. Happy Learning!</center>',
        // tooltipClass: 'myTooltipClass',
        // highlightClass: 'myHighlightClass',
      },
