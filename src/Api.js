...
const get_token = (_callback) => {
  ...
  axios
    .post(api_url + "/" + "api-token-auth" + "/", data)
    .then((res) => {
...
export const gcashcheckout = (shopItem, promoCode, _callback) => {
  get_user((res) => {
    const id = res["id"];
    const successUrl =
      process.env.REACT_APP_HOME + "/process-transaction?method=gcash";
...
export const grabpaycheckout = (shopItem, promoCode, _callback) => {
  get_user((res) => {
    const id = res["id"];
    const successUrl =
      process.env.REACT_APP_HOME + "/process-transaction?method=grabpay";
    const failUrl = process.env.REACT_APP_HOME + "/transaction-fail";
...
export const create_paymentmethod = (
  card_number,
  exp_month,
  exp_year,
  cvc,
...
export const get_payment_intent = (
  payment_method,
  payment_intent,
  client_key,
  _callback
