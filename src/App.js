      ...
      <div>
        {/* {process.env.REACT_APP_ENV == "PRODUCTION" && (
          <Fragment>
            <ScriptTag
              async
              src="https://www.googletagmanager.com/gtag/js?id=UA-190831270-1"
            />
            <noscript>
              <img
                height="1"
              ...
              <Switch>
                <Route path="/">
                  <DashboardLayout
                    ...
                    seenParentNotif={this.seenParentNotif}
                    getUserData={this.getParentData}
                  />
                </Route>
              ...
              <Switch>
                <Route path="/">
                  <TutorDashboardLayout
                    seenTutorNotif={this.seenTutorNotif}
                    getUserData={this.getTutorData}
                  />
                </Route>
                <Route path="*" component={NotFoundView} />
              </Switch>
